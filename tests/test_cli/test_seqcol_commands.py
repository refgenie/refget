...
class TestSeqcolLocalStoreLookup:
    ...
    def test_show_from_local_store(self, cli, populated_store, monkeypatch):
    ...
    def test_show_from_local_store_level1(self, cli, populated_store, monkeypatch):
    ...
    def test_compare_uses_local_store_for_digest(self, cli, populated_store, monkeypatch):
    ...
    def test_compare_local_digest_with_fasta(self, cli, populated_store, monkeypatch):
