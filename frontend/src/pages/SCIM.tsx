...
import { API_BASE, encodeToBase64, decodeFromBase64 } from '../utilities';
...
const SCIM = () => {
  ...
  const handleComparisonChange = (event: ChangeEvent<HTMLTextAreaElement>) => {
      ...
      <div>
        ...
        <div className='card mt-6'>
          <div className='card__header text-xs flex justify-between'>
            ...
            <button
              className='btn btn--danger btn--xs shadow-sm ml-1'
