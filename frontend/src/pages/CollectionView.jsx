  ...
  return (
    <div>
      ...
      <p className='text-muted fs-6 mt-3'>
        The <span className='font-monospace text-success'>/collection</span>{' '}
        endpoint lets you retrieve the value of a sequence collection, in
        various forms, given its digest.
      </p>
      {/* <hr/> */}
      <h5 className='mt-4 pt-2'>Attribute View</h5>
      <p className='text-muted fs-6'>
        Individual attributes have their own digests and values. Click on a
        digest to see the{' '}
        <span className='font-monospace text-success'>/attribute</span> page for
        that attribute value and find other collections with the same value.
      </p>
      ...
      <p className='text-muted fs-6'>
        ...
        Choose among views below to see what is returned by the different
        endpoint options.
      </p>
        ...
        <div className='col-12'>
          <div className='card'>
            ...
            <div id='collapseUncollated' className='collapse'>
              <div className='card-body'>
                <pre className='card card-body bg-light mb-0'>
                  {JSON.stringify(uncollated, null, 2)}
                </pre>
              </div>
            </div>
          </div>
