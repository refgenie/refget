...
const HPRCGenomes = () => {
  ...
  for (let j of hprc) {
    ...
    row_cells.push(
      <td>
        <a href={j.assembly_link}>{j.assembly_accession}</a>
      </td>,
    );
    row_cells.push(
      <td className='px-3'>
        <LinkedCollectionDigest digest={j.seqcol_digest} />
      </td>,
    );
  ...
  let table = (
    <div className='rounded shadow-sm border tiny overflow-x-auto mt-3'>
