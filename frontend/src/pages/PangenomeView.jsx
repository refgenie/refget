    ...
    return (<>
      <div>
        ...
        <ul>
          ...
          <li>Level 3: <Link to={api_url_level3}>{api_url_level3}</Link></li>
          <li>Level 4: <Link to={api_url_level4}>{api_url_level4}</Link></li>
        </ul>
          ...
          <tbody className="m-5">
            { itemwise.collections.map((seqCol) => (
              <tr key={seqCol.name}>
                ...
                <td><Link to={`/collection/${seqCol.collection}`}>{seqCol.collection}</Link></td>
              </tr>
            ))}
          </tbody>
        </table>
